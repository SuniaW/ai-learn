...
**基于 Spring Boot 3.4 + Spring AI 1.0 + Milvus 2.6 + Ollama 的完整技术手册**
...
- 第 2 章 系统架构与核心流转
- 第 3 章 硬件选型与两条实施路线
- 第 4 章 核心概念详解 (向量/索引/SSE)
- 第 5 章 Spring AI 版本演进与选型
- 第 6 章 Embedding 模型选型指南 (2026 版)
- 第 7 章 文档分块策略进阶 (Late Chunking)

## 第二部分：基础设施极速搭建
- 第 6 章 Docker 核心概念与最佳实践
- 第 7 章 阿里云环境初始化 (镜像/Swap/卸载)
- 第 8 章 Milvus 向量数据库深度解析
- 第 9 章 Milvus 2.6 新特性与配置变更

## 第三部分：核心组件部署与调优
- 第 10 章 Milvus 部署与 4G 内存极限优化
- 第 11 章 Ollama 模型管理与线程控制
- 第 12 章 可视化监控与端口管理
...
- 第 14 章 核心配置与自动装配陷阱
- 第 15 章 文档解析与分批向量化
- 第 16 章 RAG 检索与 SSE 流式响应
- 第 17 章 完整代码汇总 (Controller/Service/Config)
- 第 18 章 RAG 检索优化 (混合检索/Rerank)
- 第 19 章 RAG 系统评估体系

## 第五部分：前端交互与体验优化
- 第 20 章 Vue3 项目搭建
- 第 21 章 SSE 流式通信原生实现
- 第 22 章 UI/UX 优化与 Markdown 渲染

## 第六部分：低配环境极限生存指南 (重点)
- 第 23 章 2 核 4G 服务器生存法则
- 第 24 章 内存管理与 Swap 调优
- 第 25 章 组件资源配额化实战
- 第 26 章 系统级深度脱水 (0305/0309 专项)
    - 22.4 隐形内存占用排查
    - 22.5 启动顺序优化 (0305)
    - 22.6 内存泄漏排查 (0309)
...
| Milvus Standalone | 1024MB | 向量数据库的核心引擎，负责向量计算和索引。必须画出 1GB 的 "红线" | 512M-2G |
...
## 第 15 章 完整代码汇总 (Controller/Service/Config)
