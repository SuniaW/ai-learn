...
* [Spring Web](https://docs.spring.io/spring-boot/4.0.3-SNAPSHOT/reference/web/servlet.html)
* [Spring Boot DevTools](https://docs.spring.io/spring-boot/4.0.3-SNAPSHOT/reference/using/devtools.html)
